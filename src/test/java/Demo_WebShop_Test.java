...
public class Demo_WebShop_Test extends BASE{
    ...
    public void booksTest() {
        ...
        Assert.assertTrue(driver.getPageSource().contains("added"),"❌ Book not added to cart");
    }
    ...
    public void cartTest() {
        ...
        Assert.assertTrue(cp.getProduct().length() > 0);
    }
    ...
    public void jewelryTest() {
         ...
         Assert.assertTrue(driver.getPageSource().contains("added"),"❌ Jewelry product not added");
     }
    ...
    public void electronicsTest() {
        ...
        Assert.assertTrue(driver.getPageSource().contains("added"),"❌ Electronics product not added");
    }
